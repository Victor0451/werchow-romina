...
$monto=0; $accion = null; $nombre = ""; $plan=null; $fpago=null; $socio=0; $recibo=0; $cuotas=0;$total=0;$liq_id=0;$fecha=null;$caja=null;
...
if (isset($_REQUEST['btn_guardar'])){
	...
	//$fecha = $fch[2]."-".$fch[1]."-".$fch[0];
	//$ape=TraerApellido();
	$caja=$_REQUEST['caja'].$ape;
	if ($_REQUEST['liq_id'] == 0){ //Nuevo
		
		$rows = Liquidacion::insertLiquidacion($fecha,$_REQUEST['socio'],$_SESSION["usu_ide"],strtoupper($_REQUEST['nombre']),$_REQUEST['monto'],$_REQUEST['plan'],$_REQUEST['fpago'],$_REQUEST['recibo'],$_REQUEST['cuotas'],$_REQUEST['accion'],$caja);
		
		$monto=0; $accion = null; $nombre = ""; $plan=null; $fpago=null; $socio=0; $recibo=0; $cuotas=0;$total=0;$liq_id=0;$caja=null;
	}
	else{ //Modificacion
...
<body>
	...
	<div id="contenido">
		...
		<form action="" id="form" action="abm-liquidacion.php" onSubmit="return valida_envia(this);"">
			...
			<p style="font-size:0.8em;">Recibo&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cuotas a pagar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Caja&nbsp;<?php echo TraerApellido();?><br> <input type="text" name="recibo" value="<?php echo $recibo; ?>" onkeyUp="return ValNumero(this);" size=8>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="cuotas" value="<?php echo $cuotas; ?>" onkeyUp="return ValNumero(this);" size=5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="art_codigo" value="<?php echo $total; ?>" size=8 disabled>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<select name="caja" id="caja" >
				<option value= "<?php echo $caja; ?>" selected="selected"><?php echo $caja; ?></option>
				<option value="01">01 </option>
				<option value="11">11 </option>
				<option value="15">15 </option>
			</select>	</p>

			<p><input type="submit" name="btn_guardar" value="Guardar" onClick=" return valida_envia(this)">&nbsp;<input type="submit" name="btn_Limpiar" value="Limpiar">&nbsp;<input type="button" name="btn_salir" value="Salir" onclick="location.href = 'abm.php'"></p>
		</form>
		<h2>Lista</h2>
...
function VerLiquidaciones(){
	...
	foreach ($rows as $row) {
		...
		echo "<tr>
		      ...
		      <td><center><a href='?op=md&liq_id=".$row['liq_id']."'><img src='libs/img/campa.jpg' ></a><center></td>
