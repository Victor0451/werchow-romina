...
$semana=null;$estado2=null;$dni=null;
...
$asesor=$_REQUEST['asesor'];
   ...
   if (isset($_REQUEST['btn_guardar'])){
   		...
   		$rows = Produccion::updateProduccion2(1,$prod_ide, $esta, $obs,$dni);
...
<body>
	...
	<div id="contenido">	
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="text" name="nombre" value="<?php echo TraerAfiliado()?>" size="30px" disabled>	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="dni" value="<?php echo TraerDni()?>" size="8px" ></p>
		...
		<p style="font-size:0.8em;">ESTADO<br>
		...
		<textarea name="obs" rows="3" cols="100"></textarea>	

			<!--<input type="text" name="obs" size="80px" >-->
		</p>
