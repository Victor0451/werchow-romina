...
<body>
	...
	<div id="contenido">	
		...
		<div id="doctip"><h1>CONSULTA FICHA</h1></div>
		...
		<p style="font-size:0.8em;">Plan&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Forma de Pago&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CTA-CTE/N°TARJETA&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ESTADO<br>	
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="text" name="est" value="<?php echo TraerEstado();?>" size="10px" disabled>
		
		
		</p>
		
		<p style="font-size:0.8em;">OBSERVACION<br>
		<textarea name="obs" rows="3" cols="100"><?php echo TraerPago();?></textarea>	

		</p>
		
		

	<p><input type="button" name="btn_volver" value="Volver" onclick="location.href = 'cns-produccion2.php?mes=<?php echo $_REQUEST['mes'];?>&anio=<?php echo $_REQUEST['anio'];?>&btn_ver=Consultar'">
