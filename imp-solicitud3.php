...
<head>
	<meta charset="UTF-8">
	<title>Impresion Solicitud Ingreso</title>
...
<?php
	...
	$cuotas=3;
	$empre='W';	
	if ($empre='W'){$rows = Maestro::getMaestro(14,$fecha);}
	$row = $rows->fetch();
	$calle = $row['CALLE'];
	$nro = $row['NRO_CALLE'];
	$barrio = $row['BARRIO'];
...
<!--	<div id="contenido">-->
		...
		<div style="font-size:0.6em;"><b>DOMICILIO</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Calle:&nbsp;<b> <?php echo $calle;?></b>&nbsp;&nbsp;&nbsp;Nº:&nbsp;<b><?php echo $nro;?></b>&nbsp;&nbsp;&nbsp;Bº:&nbsp;<b><?php echo $barrio;?></b>&nbsp;&nbsp;&nbsp;Loc:&nbsp;<b><?php echo $loc;?></b>&nbsp;&nbsp;&nbsp;Tel:&nbsp;<b><?php echo $tel;?></b><br><b>PARTICULAR</b><br>
		<hr color=#85C1E9 size=2>
		Celular:&nbsp;<b><?php echo $cel;?></b>&nbsp;&nbsp;&nbsp;	
		...
		Lugar de Trabajo:&nbsp;<b><?php echo $domlab;?></b>&nbsp;&nbsp;&nbsp;	
		<br>
		<hr color=#85C1E9 size=2>
		DEBITO BCARIO<input type="radio" name="pago" value="DT">&nbsp;
		...
		EN EL TRABAJO<input type="radio" name="pago" value="TR">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mail:&nbsp;<b><?php echo 'ROMINA';?></b>
		<br>
		<hr color=#85C1E9 size=2>

		<b>DOMICILIO</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><?php echo $domcob;?></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DIAS DE COBRANZA (Vencimiento: 15 c/mes)&nbsp;&nbsp;&nbsp;hs:&nbsp;&nbsp;<br>
		<b>COBRANZA</b>
		</div>	
		<hr color=#85C1E9 size=2>
		<br>
		<table width="70%" border=1 style="border-collapse:collapse; font-size:0.5em;">
			<thead>
				<th>Werchow Servicios Sociales S.R.L. no es Compañia de Seguros, Obra Social, o Medicina Prepaga. Todos los afiliados que figuran en la presente declaran conocer y aceptar los planes de Werchow Servicio Sociales S.R.L.. Para la utilización de los servicios, los afiliados deberán exhibir el carnet de la empresa y la constancia de pago del mes en curso</th>
			</thead>
		</table><br>
		<div style="font-size:0.6em;">OBSERVACIONES:____________________________________________________________________________________________________________________________________________<BR>
		_____________________________________________________________________________________________________________________________________________________________</DIV> <br>
		<table width="70%" border=1 style="border-collapse:collapse; font-size:0.5em;"  >
			<thead>
				<th>Programa de fidelización: El presente programa tiene como destinatarios a todos los AFILIADOS de WERCHOW SERVICIOS SOCIALES S.R.L., que cumplan con cada uno de los siguientes requisitos, sin excepción alguna: Poseer un PLAN de SERVICIOS SOCIALES, con la cuota abonada al dia, NO mantener deuda alguna con la EMPRESA y cumplir con la cantidad de cuotas abonadas (del plan de servicios sociales elegido) al día y sin retraso o mora. El Programa de Fidelización, es un programa estímulo de Beneficios que se otorgan SIN CARGO para los AFILIADOS que cumplan con los requisitos que se mencionan en el cuadro "A". SI EL AFILIADO RENUNCIARA O POR CUALQUIER OTRO MOTIVO (FALTA DE PAGO, FALSEDAD DE DATOS, OTROS INCUMPLIMIENTOS, ETC) DEJARA DE TENER LA CALIDAD DE AFILIADO, NO PODRÁ EXIGIR, DE DARSE EL SUPUESTO, LA PRESENTACIÓN DEL PREMIO CONSISTENTE EN SERVICIO DE SEPELIO, CREMACION, ETC, ES DECIR, PERDERA TODO DERECHO AL MISMO, SIN PODER EXIGIR RESTITUCIÓN DINERARIA ALGUNA A LA EMPRESA, PORQUE LA PRESENTACION DEL SERVICIO DE SEPELIO EN QUE CONSISTE EL PREMIO RESPECTIVO ESTÁ CONDICIONADA A LA PUNTUALIDAD EN EL PAGO DE LAS CUOTAS Y A LA PERMANENCIA DE LA CALIDAD DE AFILIADO</th>
		...
		<table width="60%" border=1 style="border-collapse:collapse; font-size:0.5em;">
			<thead>
				...
				<th widt="5%" bgcolor=#DCDCDC>SERVICIO CLASICO S/CARGO</th>
				<th widt="5%" bgcolor=#DCDCDC>CREMACION S/CARGO</th>
				<th widt="5%" bgcolor=#DCDCDC>PARC.MUNICIP S/CARGO</th>
...
if ($empre=='W'){*/
	...
	foreach ($rows as $row) {
		...
		echo'<thead><th widt="5%" align="left">'.$nom.'</th>
