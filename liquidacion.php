...
<body>
	...
	<form action="" id="for_cns" method="get" >
		...
		<p>
			...
			<input type="button" name="btn_liq" value="Liquidacion Individual" onClick="JavaScript: location.href='liqu-individual.php?mes=<?php echo $_GET['mes'];?>&anio=<?php echo $_GET['anio'];?>&grupo=<?php echo $_GET['grupo'];?>';" >&nbsp;
...
if (isset($_REQUEST['btn_ver'])){
	...
	if ($per=='VENTAS'){$rows=Usuario::getUsuario(16,$grupo);}
	else{$rows=Usuario::getUsuario(16,$grupo);}
	...
	foreach ($rows as $row){
		...
		echo "<tr>
			  		<td style='text-align:center;'></td>	
			  		<td  style='text-align:center;' bgcolor=#ABEBC6><b>".$grupo."</b></td>
